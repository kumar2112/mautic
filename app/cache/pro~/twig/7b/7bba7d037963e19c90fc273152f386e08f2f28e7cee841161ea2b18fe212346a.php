...
class __TwigTemplate_22a8b0eb5653984f314211b59986d2506db8b0710607ec46df65c718b914ce1f extends Twig_Template
{
    ...
    <form action=\"";
        ...
        // line 5
        echo twig_escape_filter($this->env, (isset($context["oauth_token"]) ? $context["oauth_token"] : null), "html", null, true);
        echo "\" />
        <input type=\"hidden\" name=\"oauth_callback\" value=\"";
        // line 6
        echo twig_escape_filter($this->env, (isset($context["oauth_callback"]) ? $context["oauth_callback"] : null), "html", null, true);
        echo "\" />
...
";
    ...
    {
        return new Twig_Source("", "BazingaOAuthServerBundle::authorize.html.twig", "/var/www/html/MyProjects/Symfony/mautic/vendor/willdurand/oauth-server-bundle/Resources/views/authorize.html.twig");
    }
}
